...
/**
 * Base class that represents a row from the 'catentuni' table.
 *
 *
 *
 * @package    propel.generator..Base
 */
abstract class Catentuni implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\CatentuniTableMap';
    ...
    /**
     * The value for the dscentuni field.
     *
     * @var        string
     */
    protected $dscentuni;
    ...
    /**
     * Initializes internal state of Base\Catentuni object.
     */
    ...
    /**
     * Compares this with another <code>Catentuni</code> instance.  If
     * <code>obj</code> is an instance of <code>Catentuni</code>, delegates to
     * <code>equals(Catentuni)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|Catentuni The current object, for fluid interface
     */
    ...
    /**
     * Get the [dscentuni] column value.
     *
     * @return string
     */
    public function getDscentuni()
    {
        return $this->dscentuni;
    }
     ...
     * @return $this|\Catentuni The current object (for fluent API support)
     */
    public function setIdnentuni($v)
    {
        ...
        if ($this->idnentuni !== $v) {
            $this->idnentuni = $v;
            $this->modifiedColumns[CatentuniTableMap::COL_IDNENTUNI] = true;
        }
    ...
    /**
     * Set the value of [dscentuni] column.
     *
     * @param string $v new value
     * @return $this|\Catentuni The current object (for fluent API support)
     */
    public function setDscentuni($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }
        ...
        if ($this->dscentuni !== $v) {
            $this->dscentuni = $v;
            $this->modifiedColumns[CatentuniTableMap::COL_DSCENTUNI] = true;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            if ($this->created_at === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->created_at->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[CatentuniTableMap::COL_CREATED_AT] = true;
            }
    ...
    public function setUpdatedAt($v)
    {
        ...
        if ($this->updated_at !== null || $dt !== null) {
            if ($this->updated_at === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->updated_at->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[CatentuniTableMap::COL_UPDATED_AT] = true;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : CatentuniTableMap::translateFieldName('Idnentuni', TableMap::TYPE_PHPNAME, $indexType)];
            $this->idnentuni = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : CatentuniTableMap::translateFieldName('Dscentuni', TableMap::TYPE_PHPNAME, $indexType)];
            $this->dscentuni = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : CatentuniTableMap::translateFieldName('CreatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->created_at = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : CatentuniTableMap::translateFieldName('UpdatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            ...
            return $startcol + 4; // 4 = CatentuniTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\Catentuni'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildCatentuniQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see Catentuni::setDeleted()
     * @see Catentuni::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildCatentuniQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                CatentuniTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(CatentuniTableMap::COL_IDNENTUNI)) {
            $modifiedColumns[':p' . $index++]  = 'idnentuni';
        }
        if ($this->isColumnModified(CatentuniTableMap::COL_DSCENTUNI)) {
            $modifiedColumns[':p' . $index++]  = 'dscentuni';
        }
        if ($this->isColumnModified(CatentuniTableMap::COL_CREATED_AT)) {
            $modifiedColumns[':p' . $index++]  = 'created_at';
        }
        if ($this->isColumnModified(CatentuniTableMap::COL_UPDATED_AT)) {
            $modifiedColumns[':p' . $index++]  = 'updated_at';
        }

        $sql = sprintf(
            'INSERT INTO catentuni (%s) VALUES (%s)',
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case 'idnentuni':
                        ...
                        break;
                    case 'dscentuni':
                        $stmt->bindValue($identifier, $this->dscentuni, PDO::PARAM_STR);
                        break;
                    case 'created_at':
    ...
    {
        $pos = CatentuniTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['Catentuni'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Catentuni'][$this->hashCode()] = true;
        $keys = CatentuniTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getIdnentuni(),
            $keys[1] => $this->getDscentuni(),
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) {
            $this->setIdnentuni($arr[$keys[0]]);
        }
        if (array_key_exists($keys[1], $arr)) {
            $this->setDscentuni($arr[$keys[1]]);
        }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(CatentuniTableMap::COL_IDNENTUNI)) {
            $criteria->add(CatentuniTableMap::COL_IDNENTUNI, $this->idnentuni);
        }
        if ($this->isColumnModified(CatentuniTableMap::COL_DSCENTUNI)) {
            $criteria->add(CatentuniTableMap::COL_DSCENTUNI, $this->dscentuni);
        }
        if ($this->isColumnModified(CatentuniTableMap::COL_CREATED_AT)) {
            $criteria->add(CatentuniTableMap::COL_CREATED_AT, $this->created_at);
        }
        if ($this->isColumnModified(CatentuniTableMap::COL_UPDATED_AT)) {
            $criteria->add(CatentuniTableMap::COL_UPDATED_AT, $this->updated_at);
        }
    ...
    {
        $criteria = ChildCatentuniQuery::create();
        $criteria->add(CatentuniTableMap::COL_IDNENTUNI, $this->idnentuni);
    ...
    {
        $validPk = null !== $this->getIdnentuni();
    ...
    /**
     * Generic method to set the primary key (idnentuni column).
     *
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Catentuni (or compatible) type.
    ...
    {
        $copyObj->setDscentuni($this->getDscentuni());
        ...
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setIdnentuni(NULL); // this is a auto-increment column, so set to default value
        }
    }
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Catentuni Clone of current object.
     * @throws PropelException
     */
     ...
     * If this ChildCatentuni is new, it will return
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildCatentuni The current object (for fluent API support)
     */
    public function setTblentprds(Collection $tblentprds, ConnectionInterface $con = null)
    {
        ...
        foreach ($tblentprdsToDelete as $tblentprdRemoved) {
            $tblentprdRemoved->setCatentuni(null);
        }
     ...
     * Otherwise if this Catentuni is new, it will return
     * an empty collection; or if this Catentuni has previously
     * been saved, it will retrieve related Tblentprds from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in Catentuni.
     *
     * @param      Criteria $criteria optional Criteria object to narrow the query
     * @param      ConnectionInterface $con optional connection object
    ...
    {
        return (string) $this->exportTo(CatentuniTableMap::DEFAULT_STRING_FORMAT);
    }
