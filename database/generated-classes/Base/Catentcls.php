...
/**
 * Base class that represents a row from the 'catentcls' table.
 *
 *
 *
 * @package    propel.generator..Base
 */
abstract class Catentcls implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\CatentclsTableMap';
    ...
    /**
     * The value for the dscentcls field.
     *
     * @var        string
     */
    protected $dscentcls;
    ...
    /**
     * Initializes internal state of Base\Catentcls object.
     */
    ...
    /**
     * Compares this with another <code>Catentcls</code> instance.  If
     * <code>obj</code> is an instance of <code>Catentcls</code>, delegates to
     * <code>equals(Catentcls)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|Catentcls The current object, for fluid interface
     */
    ...
    /**
     * Get the [dscentcls] column value.
     *
     * @return string
     */
    public function getDscentcls()
    {
        return $this->dscentcls;
    }
     ...
     * @return $this|\Catentcls The current object (for fluent API support)
     */
    public function setIdnentcls($v)
    {
        ...
        if ($this->idnentcls !== $v) {
            $this->idnentcls = $v;
            $this->modifiedColumns[CatentclsTableMap::COL_IDNENTCLS] = true;
        }
    ...
    /**
     * Set the value of [dscentcls] column.
     *
     * @param string $v new value
     * @return $this|\Catentcls The current object (for fluent API support)
     */
    public function setDscentcls($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }
        ...
        if ($this->dscentcls !== $v) {
            $this->dscentcls = $v;
            $this->modifiedColumns[CatentclsTableMap::COL_DSCENTCLS] = true;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            if ($this->created_at === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->created_at->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[CatentclsTableMap::COL_CREATED_AT] = true;
            }
    ...
    public function setUpdatedAt($v)
    {
        ...
        if ($this->updated_at !== null || $dt !== null) {
            if ($this->updated_at === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->updated_at->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[CatentclsTableMap::COL_UPDATED_AT] = true;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : CatentclsTableMap::translateFieldName('Idnentcls', TableMap::TYPE_PHPNAME, $indexType)];
            $this->idnentcls = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : CatentclsTableMap::translateFieldName('Dscentcls', TableMap::TYPE_PHPNAME, $indexType)];
            $this->dscentcls = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : CatentclsTableMap::translateFieldName('CreatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->created_at = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : CatentclsTableMap::translateFieldName('UpdatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            ...
            return $startcol + 4; // 4 = CatentclsTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\Catentcls'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildCatentclsQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see Catentcls::setDeleted()
     * @see Catentcls::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildCatentclsQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                CatentclsTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(CatentclsTableMap::COL_IDNENTCLS)) {
            $modifiedColumns[':p' . $index++]  = 'idnentcls';
        }
        if ($this->isColumnModified(CatentclsTableMap::COL_DSCENTCLS)) {
            $modifiedColumns[':p' . $index++]  = 'dscentcls';
        }
        if ($this->isColumnModified(CatentclsTableMap::COL_CREATED_AT)) {
            $modifiedColumns[':p' . $index++]  = 'created_at';
        }
        if ($this->isColumnModified(CatentclsTableMap::COL_UPDATED_AT)) {
            $modifiedColumns[':p' . $index++]  = 'updated_at';
        }

        $sql = sprintf(
            'INSERT INTO catentcls (%s) VALUES (%s)',
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case 'idnentcls':
                        ...
                        break;
                    case 'dscentcls':
                        $stmt->bindValue($identifier, $this->dscentcls, PDO::PARAM_STR);
                        break;
                    case 'created_at':
    ...
    {
        $pos = CatentclsTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['Catentcls'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Catentcls'][$this->hashCode()] = true;
        $keys = CatentclsTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getIdnentcls(),
            $keys[1] => $this->getDscentcls(),
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) {
            $this->setIdnentcls($arr[$keys[0]]);
        }
        if (array_key_exists($keys[1], $arr)) {
            $this->setDscentcls($arr[$keys[1]]);
        }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(CatentclsTableMap::COL_IDNENTCLS)) {
            $criteria->add(CatentclsTableMap::COL_IDNENTCLS, $this->idnentcls);
        }
        if ($this->isColumnModified(CatentclsTableMap::COL_DSCENTCLS)) {
            $criteria->add(CatentclsTableMap::COL_DSCENTCLS, $this->dscentcls);
        }
        if ($this->isColumnModified(CatentclsTableMap::COL_CREATED_AT)) {
            $criteria->add(CatentclsTableMap::COL_CREATED_AT, $this->created_at);
        }
        if ($this->isColumnModified(CatentclsTableMap::COL_UPDATED_AT)) {
            $criteria->add(CatentclsTableMap::COL_UPDATED_AT, $this->updated_at);
        }
    ...
    {
        $criteria = ChildCatentclsQuery::create();
        $criteria->add(CatentclsTableMap::COL_IDNENTCLS, $this->idnentcls);
    ...
    {
        $validPk = null !== $this->getIdnentcls();
    ...
    /**
     * Generic method to set the primary key (idnentcls column).
     *
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Catentcls (or compatible) type.
    ...
    {
        $copyObj->setDscentcls($this->getDscentcls());
        ...
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setIdnentcls(NULL); // this is a auto-increment column, so set to default value
        }
    }
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Catentcls Clone of current object.
     * @throws PropelException
     */
     ...
     * If this ChildCatentcls is new, it will return
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildCatentcls The current object (for fluent API support)
     */
    public function setTblentprds(Collection $tblentprds, ConnectionInterface $con = null)
    {
        ...
        foreach ($tblentprdsToDelete as $tblentprdRemoved) {
            $tblentprdRemoved->setCatentcls(null);
        }
     ...
     * Otherwise if this Catentcls is new, it will return
     * an empty collection; or if this Catentcls has previously
     * been saved, it will retrieve related Tblentprds from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in Catentcls.
     *
     * @param      Criteria $criteria optional Criteria object to narrow the query
     * @param      ConnectionInterface $con optional connection object
    ...
    {
        return (string) $this->exportTo(CatentclsTableMap::DEFAULT_STRING_FORMAT);
    }
